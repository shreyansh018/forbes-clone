          ...
          <div className="grid grid-flow-row-dense lg:grid-cols-2">
            ...
            <div>
              <div className="grid grid-cols-3 pb-2 mr-20 ml-4">
                <h1 className="text-xs lg:pt-1 lg:pl-7 lg:pb-1 m-auto rounded-lg bg-blue-200 font-semibold text-blue-800">
                  BEST CASH BACK, BEST NO ANNUAL FEE CARD
                </h1>
              </div>

              <div>
                <h1 className="pl-7 text-xl lg:text-3xl font-bold">
                  Chase Freedom Flex℠
                </h1>
              </div>
            </div>
            ...
            <div className="text-center pt-3 ml-20 mr-20">
              <h1 className="text-white text-xl lg:text-2xl font-bold bg-green-500 hover:bg-green-600 hover:duration-200 hover:ease-out duration-200 rounded-lg ml-20 mr-20 lg:p-3 cursor-pointer">
                Apply Now
              </h1>
